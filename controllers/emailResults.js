...
// MIDDLEWARE SETUP - Move this to the top
app.use(express.json());

// Request logging middleware - Move this before routes
...
// Test email connection on startup - FIXED: createTransport instead of createTransporter
const testEmailConnection = async () => {
  try {
    log.info('📧 Testing email connection...');
    const transporter = nodemailer.createTransport(emailConfig); // FIXED HERE
...
// Health check endpoint - Move this before the main endpoint
...
app.post('/generate-pdf', async (req, res) => {
  ...
  try {
    ...
    // 5. Send email - FIXED: createTransport instead of createTransporter
